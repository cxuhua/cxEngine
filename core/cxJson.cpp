...
//cxJson &cxJson::operator<<(cchars s)
//{
//    if(IsObject()){
...
//}
//
//cxJson &cxJson::operator<<(cxBool v)
//{
//    if(IsObject()){
//        CX_ASSERT(key.size() > 0, "key not set");
//        Set(key.data(), v);
...
//}
//
//cxJson &cxJson::operator<<(cxInt v)
//{
//    if(IsObject() &&key.size() > 0){
//        Set(key.data(), v);
//        key.clear();
//    }else{
//        Append(v);
...
//}
//
//cxJson &cxJson::operator<<(cxLong v)
//{
//    if(IsObject() &&key.size() > 0){
//        Set(key.data(), v);
//        key.clear();
...
//}
//
//cxJson &cxJson::operator<<(cxInt64 v)
//{
//    if(key.size() > 0){
//        Set(key.data(), v);
//        key.clear();
...
//}
//
//cxJson &cxJson::operator<<(const cxStr *s)
//{
//    if(key.size() > 0){
//        Set(key.data(), s);
//        key.clear();
...
//}
//
//cxJson &cxJson::operator<<(cxFloat v)
//{
//    if(key.size() > 0){
//        Set(key.data(), v);
//        key.clear();
